---
title: "[Leetcode] LRU Cache (Median)"
date: "2026-01-23"
Tags: [Leetcode]
Category: "Leetcode"
Published: True
...
<br />
link:
[https://neetcode.io/problems/lru-cache/question](https://neetcode.io/problems/lru-cache/question)
...
* the dll (`doubly linked list`)
  ...
  - we use a dll and not a sll because removing a node from the middle of a list requires _updating the pointers of the previous node_
...
# Time complexity
    ...
    - `O(1)` for each `put()` and `get()` operations
